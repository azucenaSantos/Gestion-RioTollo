...
<body class="text-center">
    ...
    <main class="form-signin mb-5">
        <form class="mx-auto p-5 shadow-sm" method="post" action="?c=User&a=login">
            <img class="mt-4" src="/GestionRioTollo/assets/img/logo.jpg" alt="Logotipo Rio Tollo" width="220px"
                height="220px">
            <h1 class="mt-4">Inicio de sesión</h1>
            <div class="form-inputs">
                <div class="checkbox mt-5">
                    <label for="inputEmail">Usuario</label>
                    <input type="text" class="form-control <?php echo isset($errorUser) ? 'input-error' : ''; ?>"
                ...
                <div class="checkbox mt-3">
                    ...
                    <div class="input-group">
                        <input type="password"
                            ...
                            id="inputPassword" name="password" value="<?php
                ...
                <div class="checkbox mt-3 mb-3">
                    <div class="form-forgot">
                        <a href="../view/sesion/cambiar_password.php">He olvidado mi contraseña</a>

    ...
    <div class="content">
            ...
            <div class="container-fluid lateral-menu">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        <li class="nav-item">
                            <a href="../../public/index.php?c=Trabajador&a=verParte" class="nav-section">
        ...
        <main class="d-flex flex-column align-items-center">
            <div class="info-container">
                <h1 class="text-center">Bienvenido al Panel de Trabajador</h1>
                <p class="text-center">Desde aquí podrás visualizar los partes de los trabajos que debe realizar.</p>
            </div>
            <div class="container mt-5">
                <div class="row text-center">
                    <div class="col-md-12">
                        <a href="../../public/index.php?c=Trabajador&a=verParte">

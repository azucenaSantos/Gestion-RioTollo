(function (global, factory) {
    ...
    function SideBySideMultiselect(options) {
      ...
      var labelFilter = labels && labels.filter ? labels.filter : 'Búsqueda por número';
      var labelSelected = labels && labels.selected ? labels.selected : 'Seleccionadas: ';
      /**
      ...
      var createFilter = function createFilter(select, wrapper) {
        ...
        filterLabel.innerText = "Busqueda";
        ...
        if (options.showfilterplaceholder) {
          filterField.setAttribute('placeholder', "Busqueda");
        }
